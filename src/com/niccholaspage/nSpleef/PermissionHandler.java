...
public class PermissionHandler {
	...
	public static void init(Server server){
		...
		if (groupManager != null){
			...
			System.out.println("[nSpleef] Could not find any Permissions plugin, disabling.");
			server.getPluginManager().disablePlugin(server.getPluginManager().getPlugin("nSpleef"));
		}
	}
